                                ...
                                Data.map ((Item) => (
                                  ...
                                  <div className=" flex flex-col rounded-lg shadow-lg overflow:hidden" key={Item.id}>
                                      <div className="flex-shrink-0 relative h-60" id="Header">
                                          <Image src={Item.image} alt={Item.name} className="w-full object-cover rounded-t-lg" fill id="ImageScaling"/>
                                      </div>
                                      <div className="flex-1 bg-white p-6 flex flex-col justify-between rounded-b-lg">
                                          ...
                                          <div className=" flex flex-row justify-between py-8">
                                              <p className="flex flex-row capitalize text-sm text-neutral-700 mb-2"> <span className="text-red-600 mr-2 text-sm">
                                                <svg fill="none" className='w-5 h-5' stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
