...
import cleanImg from '../../../../public/images/2.jpg'

export default function Experience() {
  return (
    <div className='lg:w-10/12 mx-auto px-6 py-16'>
                              <div className='grid lg:grid-cols-2 gap-8 xl:space-y-0 space-y-4'>
                    ...
                    <div className='h-full space-y-4 justify-center items-center'>
                      <div>
                        <h2 className='text-neutral-700 font-semibold text-4xl uppercase tracking-wide py-4'>why choose us</h2>
                        ...
                        <div className='grid md:grid-cols-2 gap-6'>
                            <div className='space-y-6 md:py-6 md:pt-0 pt-6'>
                              ...
                              <p className='flex flex-row items-center text-neutral-600 text-sm uppercase font-semibold space-x-4'>
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M5 12.0002C5.00024 8.66068 7.35944 5.78639 10.6348 5.1351C13.9102 4.48382 17.1895 6.23693 18.4673 9.32231C19.7451 12.4077 18.6655 15.966 15.8887 17.8212C13.1119 19.6764 9.41127 19.3117 7.05 16.9502C5.73728 15.6373 4.99987 13.8568 5 12.0002Z" stroke="#07286f" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path fillRule="evenodd" clipRule="evenodd" d="M14 9.92018C13.923 8.78975 12.949 7.93278 11.818 8.00018H10V11.8402H11.818C12.949 11.9076 13.923 11.0506 14 9.92018Z" stroke="#07286f" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M10 11.8402V16.0002" stroke="#07286f" strokeWidth="1.5" strokeLinecap="round"/>
                                </svg></span>
                                <span className='hover:text-[#07286f] cursor-pointer ease-in-out duration-300'>ample parking spaces</span>
                              </p>
                            </div>
                            <div className='space-y-6 md:py-6 md:pt-0'>
                              <p className='flex flex-row items-center text-neutral-600 text-sm uppercase font-semibold space-x-4'>
