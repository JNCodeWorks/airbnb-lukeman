        ...
        <div className='grid lg:grid-cols-2 gap-6'>
            <div className='space-y-6'>
                <div className='space-y-3'>
                    ...
                    <p className='text-[#53afe5] uppercase font-semibold'>
                        some word about us
                    </p>
                </div>
                <div className='space-y-3'>
                    <p className='font-semibold text-neutral-700'>
                        Lukeman Homestays & Airbnb offers serene accommodations nestled amidst the enchanting landscapes of Kenya.
                    </p>
                ...
                <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                        <p className='text-[#53afe5] hover:text-[#f8a72a] ease-in-out duration-500'>
