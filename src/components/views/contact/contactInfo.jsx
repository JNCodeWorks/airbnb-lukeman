        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-2 gap-6'>
            ...
            <div className='lg:mx-auto'>
                <Link href={"tel://123235598"} className='flex flex-col space-y-2 text-sm'>
                    <span className='capitalize text-neutral-700 font-medium'>phone:&nbsp;</span><span className='text-[#ff3f3f]'>+256 712 345 678</span>
                </Link>
            </div>

            <div className='lg:mx-auto'>
                <Link href={"mailto:info@heartofhelp.org"} className='flex flex-col space-y-2 text-sm'>
                    <span className='capitalize text-neutral-700 font-medium'>email:&nbsp;</span><span className='text-[#ff3f3f]'>info@test.com</span>
                </Link>
            </div>

            <div className='lg:mx-auto'>
                <Link href={"/"} className='flex flex-col space-y-2 text-sm'>
                    <span className='capitalize text-neutral-700 font-medium'>website:&nbsp;</span><span className='text-[#ff3f3f]'>lukeman.com</span>
                </Link>
            </div>
        </div>
    </div>
