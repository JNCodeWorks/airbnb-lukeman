                    ...
                    <div className=" mt-2 md:p-6">
                        <div className="lg:grid lg:grid-cols-2 lg:gap-6 mb-8">
                            <div className="prose prose-lg text-gray-500 mb-6 lg:max-w-none lg:mb-0 text-base">
                                ...
                                <p><strong>“We”, “Us”, “Our”</strong> - refers to Lukeman Homestays & AirBnB.</p>
                                ...
                                <p>
                                    ...
                                    and software is the property of the Lukeman Homestays & AirBnB or its content suppliers and is protected by applicable copyright and trademark laws.
                                </p>
                                <p>
                            ...
                            <div className="prose prose-lg text-gray-500 text-base">
                                ...
                                <p>
                                    ...
                                    and/or functions therein and we expressly disclaim liability for errors and omissions in such materials, information and/or functions. Without derogation of the above and/or the terms and conditions of the applicable agreements governing all the products and services of the Lukeman Homestays & AirBnB, reasonable measures will be taken by us to ensure the accuracy and validity of all information relating to
                                    transactions and products of Lukeman Homestays & AirBnB which originate exclusively from Lukeman Homestays & AirBnB.
                                </p>
                                <p>
