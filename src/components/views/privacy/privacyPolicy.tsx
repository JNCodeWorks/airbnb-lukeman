    ...
    <div className={'lg:w-10/12 mx-auto px-6 xl:px-0 mt-32 mb-16'}>
         <div className={'max-w-none mx-auto'}>
            ...
            <div className={'max-w-none mx-auto mt-6 pb-8'}>
                <p className={'capitalize text-gray-600 text-lg text-left'}>updated May 10, 2024</p>
            </div>
        </div>
        ...
        <div className='max-w-4xl space-y-3'>
            ...
            <p className={'text-base text-neutral-600 leading-7'}>We take the security and confidentiality of your personal data very seriously. We use up-to-date data storage and security techniques to protect your personal information from unauthorized access, improper use or disclosure, unauthorized modification, unlawful destruction, or accidental loss.</p>
            <p className={'text-base text-neutral-600 leading-7'}>All processors of personal data and any third parties we engage to process your personal information are obligated to respect the confidentiality of your information.</p>
            <p className={'text-base text-neutral-600 leading-7'}>We keep your personal data for only as long as reasonably necessary for the purposes for which it was collected or to comply with any applicable legal reporting or document retention requirements.</p>
            <p className={'text-base text-neutral-600 leading-7'}>We protect your personal data during transit using encryption protocols such as Transport Layer Security (TLS). We use computer systems with limited-access protocols, housed in facilities using physical, electronic, and procedural security measures to protect the confidentiality and security of information transmitted to us. We keep strict security standards to prevent any unauthorized access.</p>

            <h2 className={'text-[#07286f] uppercase font-bold text-2xl'}>notification of changes to this policy</h2>
            <p className={'text-base text-neutral-600 leading-7'}>We are continually improving and adding new functionality and features to this website and all associated websites, as well as improving and adding to our existing services. Because of these ongoing changes, and changes in the law and the nature of technology, our data practices will change from time to time.</p>
            <p className={'text-base text-neutral-600 leading-7'}>When it proves necessary to change our Policy, we will post any changes on this page so that you are always aware of what information we collect and how we use it. You are advised to review this Privacy Policy periodically for any changes.</p>
            <p className={'text-base text-neutral-600 leading-7'}>We will let you know via email and / or a prominent notice on our Service, prior to the change becoming effective and update the “effective date” at the top of this Privacy Policy. </p>
