...
export default function Responsive() {
  ...
  return (
    <div className='lg:hidden'>
      ...
      <div className={navbar ? 'navbar active shadow xl:hidden flex justify-between w-full px-8 items-center border-b border-transparent sm:border-gray-200' : 'navbar xl:hidden flex justify-between w-full px-8 items-center border-b border-transparent sm:border-gray-200'}>
