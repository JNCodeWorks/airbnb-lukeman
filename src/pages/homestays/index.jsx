                                      ...
                                      <div className="flex-1 bg-white p-6 flex flex-col justify-between rounded-b-lg">
                                          ...
                                          <div className="flex-1 -mt-2">
                                              <div className="flex flex-row items-center justify-between">
                                                  ...
                                                  <Link href={`/homestays/${posts.fields.slug}`} className="rounded-md px-4 py-2 bg-[#53afe5] hover:bg-[#f8a72a] ease-in-out duration-500 capitalize text-white">view</Link>
                                              </div>
                                          </div>
                                      </div>  
                                  </div>
