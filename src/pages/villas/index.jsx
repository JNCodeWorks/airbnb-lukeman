import { getBlogPosts } from "../../../lib/villas";
import Image from "next/image";
import Link from "next/link";
import { useState } from "react";
import Layout from "../../components/constants/layout/layout"
import Banner from "../../components/views/villas/banner"
    ...
    return(
      ...
      <div className='mt-8 grid gap-6 mx-auto lg:grid-cols-2 md:grid-cols-2 lg:max-w-none'>
          {currentPosts.map((posts) => (
              <div className="mx-3 bg-white rounded-sm shadow-md overflow-hidden flex flex-col h-full" key={posts.sys.id}>
                  {/* Image Slider */}
                  <Slider {...settings}>
